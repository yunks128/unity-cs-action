...
// src/proto/unity-management-console/protobuf/extensions.ts
var _m0 = __toESM(require_minimal2());
function createBaseActionMeta() {
  return {
    metadataVersion: "",
    exectarget: "",
    deploymentName: "",
...
var ActionMeta = {
  ...
  fromJSON(object) {
    return {
      ...
      services: Array.isArray(object == null ? void 0 : object.services) ? object.services.map((e) => ActionMeta_Services.fromJSON(e)) : [],
      extensions: isSet(object.extensions) ? ActionMeta_Extensions.fromJSON(object.extensions) : void 0,
      deploymentType: isSet(object.deploymentType) ? String(object.deploymentType) : ""
    };
  },
  toJSON(message) {
    const obj = {};
    message.metadataVersion !== void 0 && (obj.metadataVersion = message.metadataVersion);
    message.exectarget !== void 0 && (obj.exectarget = message.exectarget);
    message.deploymentName !== void 0 && (obj.deploymentName = message.deploymentName);
    if (message.services) {
      obj.services = message.services.map((e) => e ? ActionMeta_Services.toJSON(e) : void 0);
    } else {
      obj.services = [];
    }
    message.extensions !== void 0 && (obj.extensions = message.extensions ? ActionMeta_Extensions.toJSON(message.extensions) : void 0);
    message.deploymentType !== void 0 && (obj.deploymentType = message.deploymentType);
    return obj;
  },
  create(base) {
  ...
  fromPartial(object) {
    ...
    message.services = ((_a = object.services) == null ? void 0 : _a.map((e) => ActionMeta_Services.fromPartial(e))) || [];
    message.extensions = object.extensions !== void 0 && object.extensions !== null ? ActionMeta_Extensions.fromPartial(object.extensions) : void 0;
    message.deploymentType = object.deploymentType ?? "";
    return message;
  }
};
function createBaseActionMeta_Services() {
  return { name: "", source: "", version: "", branch: "" };
}
var ActionMeta_Services = {
  encode(message, writer = _m0.Writer.create()) {
    if (message.name !== "") {
  ...
  toJSON(message) {
    ...
    message.branch !== void 0 && (obj.branch = message.branch);
    return obj;
  },
  create(base) {
...
function createBaseActionMeta_Extensions() {
  return { eks: void 0, apis: void 0 };
}
var ActionMeta_Extensions = {
  encode(message, writer = _m0.Writer.create()) {
    if (message.eks !== void 0) {
      ActionMeta_Extensions_Eks.encode(message.eks, writer.uint32(10).fork()).ldelim();
    }
    if (message.apis !== void 0) {
  ...
  fromJSON(object) {
    return {
      eks: isSet(object.eks) ? ActionMeta_Extensions_Eks.fromJSON(object.eks) : void 0,
      apis: isSet(object.apis) ? ActionMeta_Extensions_Apigateway.fromJSON(object.apis) : void 0
    };
  },
  toJSON(message) {
    const obj = {};
    message.eks !== void 0 && (obj.eks = message.eks ? ActionMeta_Extensions_Eks.toJSON(message.eks) : void 0);
    message.apis !== void 0 && (obj.apis = message.apis ? ActionMeta_Extensions_Apigateway.toJSON(message.apis) : void 0);
    return obj;
  },
  create(base) {
  ...
  fromPartial(object) {
    const message = createBaseActionMeta_Extensions();
    message.eks = object.eks !== void 0 && object.eks !== null ? ActionMeta_Extensions_Eks.fromPartial(object.eks) : void 0;
    message.apis = object.apis !== void 0 && object.apis !== null ? ActionMeta_Extensions_Apigateway.fromPartial(object.apis) : void 0;
    return message;
  }
};
function createBaseActionMeta_Extensions_Apis() {
  return { name: "" };
}
var ActionMeta_Extensions_Apis = {
  encode(message, writer = _m0.Writer.create()) {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
...
function createBaseActionMeta_Extensions_Apigateway() {
  return { apis: [] };
}
var ActionMeta_Extensions_Apigateway = {
  encode(message, writer = _m0.Writer.create()) {
  ...
  fromJSON(object) {
    return {
      apis: Array.isArray(object == null ? void 0 : object.apis) ? object.apis.map((e) => ActionMeta_Extensions_Apis.fromJSON(e)) : []
    };
  },
  toJSON(message) {
    const obj = {};
    if (message.apis) {
      obj.apis = message.apis.map((e) => e ? ActionMeta_Extensions_Apis.toJSON(e) : void 0);
    } else {
      obj.apis = [];
    }
    return obj;
  ...
  fromPartial(object) {
    var _a;
    const message = createBaseActionMeta_Extensions_Apigateway();
    message.apis = ((_a = object.apis) == null ? void 0 : _a.map((e) => ActionMeta_Extensions_Apis.fromPartial(e))) || [];
    return message;
  }
};
function createBaseActionMeta_Extensions_Nodegroups() {
  return { name: "", instancetype: "", nodecount: "" };
}
var ActionMeta_Extensions_Nodegroups = {
  encode(message, writer = _m0.Writer.create()) {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
  ...
  toJSON(message) {
    const obj = {};
    message.name !== void 0 && (obj.name = message.name);
    message.instancetype !== void 0 && (obj.instancetype = message.instancetype);
    message.nodecount !== void 0 && (obj.nodecount = message.nodecount);
    return obj;
  },
  create(base) {
...
function createBaseActionMeta_Extensions_Eks() {
  return { clustername: "", owner: "", projectname: "", nodegroups: [] };
}
var ActionMeta_Extensions_Eks = {
  encode(message, writer = _m0.Writer.create()) {
  ...
  fromJSON(object) {
    return {
      ...
      nodegroups: Array.isArray(object == null ? void 0 : object.nodegroups) ? object.nodegroups.map((e) => ActionMeta_Extensions_Nodegroups.fromJSON(e)) : []
    };
  },
  toJSON(message) {
    const obj = {};
    message.clustername !== void 0 && (obj.clustername = message.clustername);
    message.owner !== void 0 && (obj.owner = message.owner);
    message.projectname !== void 0 && (obj.projectname = message.projectname);
    if (message.nodegroups) {
      obj.nodegroups = message.nodegroups.map((e) => e ? ActionMeta_Extensions_Nodegroups.toJSON(e) : void 0);
    } else {
      obj.nodegroups = [];
    }
    return obj;
  ...
  fromPartial(object) {
    ...
    message.nodegroups = ((_a = object.nodegroups) == null ? void 0 : _a.map((e) => ActionMeta_Extensions_Nodegroups.fromPartial(e))) || [];
    return message;
  }
};
...
async function spinUpEKS(meta, token, awskey, awssecret, awstoken) {
  ...
  if (meta.exectarget !== "github") {
    input = {
      META: JSON.stringify((_a = meta.extensions) == null ? void 0 : _a.eks)
    };
  } else if (awskey !== "") {
    input = {
      META: JSON.stringify((_b = meta.extensions) == null ? void 0 : _b.eks),
      KEY: awskey,
      SECRET: awssecret,
      TOKEN: awstoken
    };
    ...
    input = {
      META: JSON.stringify((_c = meta.extensions) == null ? void 0 : _c.eks)
    };
  }
  console.log("call eks workflow with key");
  if (Object.prototype.hasOwnProperty.call((_d = meta.extensions) == null ? void 0 : _d.eks, "nodegroups")) {
    if (meta.exectarget === "github") {
      ...
      const ls = (0, import_child_process.spawn)("act", [
        ...
        "--input",
        "META=" + JSON.stringify((_e = meta.extensions) == null ? void 0 : _e.eks)
      ]);
...
async function tearDownEKS(meta, token, awskey, awssecret, awstoken) {
  ...
  if (Object.prototype.hasOwnProperty.call(meta, "extensions")) {
    ...
    console.log("call eks workflow with key");
    if (Object.prototype.hasOwnProperty.call(meta["extensions"], "kubernetes") && Object.prototype.hasOwnProperty.call((_d = meta.extensions) == null ? void 0 : _d.eks, "nodegroups")) {
      if (meta.exectarget === "github") {
...
async function spinUpTearDownProjects(meta, token, teardown) {
  var _a, _b;
  if (meta.services) {
    const eksClusterName = ((_b = (_a = meta.extensions) == null ? void 0 : _a.eks) == null ? void 0 : _b.clustername) || "defaultClusterName";
...
// src/apigateway/unity-apigateway.ts
var import_child_process2 = require("child_process");
async function tearDownApiGateway(meta, token) {
  var _a, _b, _c, _d;
  let api;
  const workflowname = "deploy_project_apigateway.yml";
  if (meta.exectarget === "github") {
    if ((_a = meta.extensions) == null ? void 0 : _a.apis) {
      for (api of (_b = meta.extensions) == null ? void 0 : _b.apis.apis) {
        await spinUpApiGatewayApiGithub(api.name, token, workflowname, "true");
      }
    }
  } else {
    if ((_c = meta.extensions) == null ? void 0 : _c.apis) {
      for (api of (_d = meta.extensions) == null ? void 0 : _d.apis.apis) {
        await spinUpApiGatewayApi(api.name, workflowname, "true");
      }
    }
  }
}
async function spinUpApiGateway(meta, token) {
  var _a, _b, _c, _d;
  let api;
  const workflowname = "deploy_project_apigateway.yml";
  if (meta.exectarget === "github") {
...
async function spinUpApiGatewayApi(name, workflowname, teardown) {
  console.log("launching act");
  console.log("writing parameters");
  const ls = (0, import_child_process2.spawn)("act", [
    "-W",
    process.env.WORKFLOWPATH + "/" + workflowname,
    "--input",
    "awsConnection=iam",
